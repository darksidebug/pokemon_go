<template>
    <div class="border-b border-gray-200 bg-white">
        <div class="container mx-auto px-4 sm:px-2">
            <nav class="py-2.5 dark:bg-gray-800">
                <div class="flex flex-wrap justify-between items-center">
                    <div class="flex flex-wrap justify-between items-center">
                        <a href="#" class="flex items-center">
                            <span class="self-center text-xl font-semibold whitespace-nowrap dark:text-white">PokemonGo</span>
                        </a>
                        <div class="hidden justify-between items-center w-full md:flex md:w-auto md:order-1 ml-0 md:ml-14" id="mobile-menu-4">
                            <ul class="flex flex-col mt-4 md:flex-row md:space-x-8 md:mt-0 md:font-medium">
                                ...
                                <li>
                                    ...
                                    hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0
                                    md:dark:hover:text-white dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white 
                                    md:dark:hover:bg-transparent dark:border-gray-700">My Profile</router-link>
                                </li>
                                <!-- <li>
                                    <a href="#" class="block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 
                                    hover:bg-gray-50 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 md:dark:hover:text-white 
                    ...
                    <div class="flex md:order-2 py-2">
                        <!-- <button type="button" class="text-blue-700 bg-white border-2 border-blue-700 hover:border-blue-800 hover:text-white hover:bg-blue-800 focus:ring-4 focus:outline-none 
                            focus:ring-blue-300 font-medium rounded px-5 py-2 text-center mr-1 dark:bg-blue-800 
                            dark:hover:bg-blue-800 dark:focus:ring-blue-800">Profile</button> -->
                        <button @click.prevent="logout" type="button" class="text-white bg-blue-700 border-2 border-blue-700 hover:border-blue-800 hover:text-white hover:bg-blue-800 focus:ring-4 focus:outline-none 
                            focus:ring-blue-300 font-medium rounded px-5 py-2 text-center mr-1 dark:bg-blue-800 
                            dark:hover:bg-blue-800 dark:focus:ring-blue-800">Sign-out</button>
                        <button data-collapse-toggle="mobile-menu-4" type="button" class="inline-flex items-center p-2 text-sm text-gray-500 rounded-lg md:hidden 
                            hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 
                            dark:focus:ring-gray-600" aria-controls="mobile-menu-4" aria-expanded="false">
